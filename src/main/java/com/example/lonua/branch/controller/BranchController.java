...
public class BranchController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "지점 등록 성공", content = @Content(schema = @Schema(implementation = BaseRes.class)))}
    )
    @ApiOperation(value = "지점 등록하기")
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "지점 목록 조회 성공", content = @Content(schema = @Schema(implementation = BaseRes.class))),
    })
    @ApiOperation(value = "지점 목록 조회하기")
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "지점 조회 성공", content = @Content(schema = @Schema(implementation = BaseRes.class))),
    })
    @ApiOperation(value = "지점 하나 조회하기")
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "지점 정보 수정 성공", content = @Content(schema = @Schema(implementation = BaseRes.class))),
    })
    @ApiOperation(value = "지점 상세 정보 수정하기")
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "지점 삭제 성공", content = @Content(schema = @Schema(implementation = BaseRes.class))),
    })
    @ApiOperation(value = "지점 삭제하기")
